 ...
 *       Module:  NVIC
 *
 *  Description: This header file for nested vector interrupt      
 *  
 *********************************************************************************************************************/
#ifndef NVIC_H_
#define NVIC_H_
 ...
 *********************************************************************************************************************/
	/* *********NVIC Addressess ****************** */
	#define NVIC0_ON    		(*((volatile u32int *)0xE000E100))
	#define NVIC1_ON    		(*((volatile u32int *)0xE000E104))
	#define NVIC2_ON    		(*((volatile u32int *)0xE000E108))
	#define NVIC3_ON    		(*((volatile u32int *)0xE000E10C))
	#define NVIC4_ON    		(*((volatile u32int *)0xE000E110))
	/* ********* NVIC disabling Addressess     ****************** */
	#define NVIC0_OFF   		(*((volatile u32int *)0xE000E180))
	#define NVIC1_OFF   		(*((volatile u32int *)0xE000E184))
	#define NVIC2_OFF   		(*((volatile u32int *)0xE000E188))
	#define NVIC3_OFF   		(*((volatile u32int *)0xE000E18C))
	#define NVIC4_OFF   		(*((volatile u32int *)0xE000E190))

/**********************************************************************************************************************
 *  GLOBAL FUNCTION MACROS
 ******************************* NVIC ADDRESSESS OFFSET **************************************************************************************/
	#define NVIC0_ON_OFFSET				0x100
	#define NVIC1_ON_OFFSET				0x104
	#define NVIC2_ON_OFFSET				0x108
	#define NVIC3_ON_OFFSET				0x10C
	#define NVIC4_ON_OFFSET				0x110
	#define NVIC0_OFF_OFFSET			0x180
	#define NVIC1_OFF_OFFSET			0x184
	#define NVIC2_OFF_OFFSET			0x188
	#define NVIC3_OFF_OFFSET			0x18C
	#define NVIC4_OFF_OFFSET			0x190
	#define NVIC0_PENDING_OFFSET		0x200
	#define NVIC1_PENDING_OFFSET		0x204
...
void NVIC_enableIRQ(INT_TYPE IRQn);

void NVIC_disableIRQ(INT_TYPE IRQn);
